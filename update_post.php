...
<body>
    <nav class="navbar navbar-expand-lg text-dark bg-light ">
      ...
      <main class = "content bg-light container py-2">
       ...
       <form  class = "col-md-6" method = "POST" action="http://localhost/Blog/update.php">
        <input name = "author" type="hidden" value="">
          ...
          <div class="row mb-3">
            <label for="Name" class="col-sm-2 col-form-label">seo_title</label>
            <div class="col-sm-10">
              <input name="seo" type="text" class="form-control" id="inputPassword3">
            </div>
          </div>
          <div class="row mb-3">
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <textarea name="content" id = "Message" class = "w-100 p-1" type = "text">
          ...
          <div class="row mb-3">
            <div class="col-sm-10 offset-sm-2">
              <button type="submit" class="btn btn-primary fs-4 px-2">update</button> 
            </div>
          </div>
   ...
   <div class="container-fluid">
      <div class="row justify-content-center custom-margin">
         <div class="col-sm-6 col-md-4">
            ...
            <h1 class="text-white f-s font-weight-bold">Update Post</h1>
            <form method = "POST" action="http://localhost/Blog/update.php"class="shadow-lg p-4 text-white">
              <input name = "author" type="hidden" value="<?php echo $_SESSION['author']?>">
              <div class="form-group">
                  <i class="fas fa-user"></i>
                  <label for="title" class="pl-2 font-weight-bold">Enter Event_author(original name)</label>
                  <input name="title" type="text"
                     class="form-control" placeholder="title" id = 'title' required >
    </div>
    <div class="form-group">
                     <i class="fas fa-user"></i>
                  <label for="seo" class="pl-2 font-weight-bold">Enter Event_title(original name)</label>
               ...
               <div class="form-group">
                     <i class="fas fa-user"></i>
                  <label for="content" class="pl-2 font-weight-bold">enter content (to_update)</label>
               ...
               <div class="form-group">
                     <i class="fas fa-user"></i>
                  <label for="url" class="pl-2 font-weight-bold">enter Avatar URL (to_update)</label>
