...
<body>
    <nav class="navbar navbar-expand-lg text-dark bg-light ">
      ...
      <main class = "content bg-light container py-2">
       ...
       <form  class = "col-md-6" method = "POST" action="http://localhost/Blog/admin/php/add_author.php">
          ...
          <div class="row mb-3">
            <div class="col-sm-10 offset-sm-2">
              <button type="submit" class="btn btn-primary fs-4 px-2">Add Author</button> 
            </div>
          </div>
    ...
    <img class = "img2" src = "https://img.collegedekhocdn.com/media/img/institute/logo/cgc_3.jpeg" alt = "">
      ...
      <div class="row justify-content-center custom-margin">
         <div class="col-sm-6 col-md-4">
            ...
            <h1 class="text-blue f-s font-weight-bold">Sign Up</h1>
            <h1 class="text-blue f-s font-weight-bold">Already have an account? <a href= "http://localhost/Blog/login.php"><button type="submit"  class="btn btn-outline-success btn-block shadow-sm font-weight-bold ">login</button></a></h1>
