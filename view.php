...
<body>
    <nav class="navbar navbar-expand-lg text-dark bg-light ">
      ...
      <main class = "content bg-light container py-2">
       ...
       <form  class = "col-md-6" method = "POST" action="http://localhost/Blog/view_source.php">
        <input name = "author" type="hidden" value="<?php echo $_SESSION['author']?>">
          ...
          <div class="row mb-3">
            <div class="col-sm-10 offset-sm-2">
              <button type="submit" class="btn btn-primary fs-4 px-2">view</button> 
            </div>
          </div>
...
<body>
   ...
   <div class="container-fluid">
      <div class="row justify-content-center custom-margin">
         ...
         <h1 class="text-white f-s font-weight-bold">View Post</h1>
            <!-- Add bg-primary in form tag if want form background color-->
            <!--text-white if want text color white-->
            <form method = "POST" action="http://localhost/Blog/view_source.php"class="shadow-lg p-4 text-white">
              <input name = "author" type="hidden" value="<?php echo $_SESSION['author']?>">
              <div class="form-group">
                  <i class="fas fa-user"></i>
                  <label for="title" class="pl-2 font-weight-bold">Event_title</label>
   ...
   <footer   class="py-4 custom-margin">
        <div class="container">
